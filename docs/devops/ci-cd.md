---
title: CI/CD 工具：GitHub Actions 与 Jenkins
description: GitHub Actions 概念、工作流语法和 Jenkins 基础。
---

# CI/CD 工具：GitHub Actions 与 Jenkins

先理解 GitHub Actions 的组成与配置，再补充 Jenkins 的基本使用。
